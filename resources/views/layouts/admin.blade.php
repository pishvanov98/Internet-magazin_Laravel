                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.manufacturer')}}" class="nav-link flex_block @if(!empty($page) && $page == "manufacturer") active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Производители товаров</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.attribute')}}" class="nav-link flex_block @if(!empty($page) && $page == "attribute") active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Атрибуты товаров</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.product')}}" class="nav-link flex_block @if(!empty($page) && $page == "product") active @endif">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Товары</p>
                                </a>
                            </li>
